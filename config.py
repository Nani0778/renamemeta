...
class Config(object):
    ...
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "6487314038:AAHyEnNRnf_imx_TmwaejYtu4rUIydayuEI") 
    ...
    FORCE_SUB   = os.environ.get("FORCE_SUB", "-1002202875746") 
    LOG_CHANNEL = int(os.environ.get("LOG_CHANNEL", "-1001928455890"))
